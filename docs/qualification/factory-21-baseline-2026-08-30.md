...
# Historical Factory .21 baseline — 30 August 2026

This is retained historical evidence. It is not a current image, Cloud topology,
Unit identity or reproduction instruction. See [the current baseline](current-baseline.md)
and [Factory .33 qualification](factory-33-e2e-2026-09-13.md).
