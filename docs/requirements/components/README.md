...
| 2 | [`CR-KAC`](../component-decomposition-and-interface-register.md#cr-kac) | [Current-Release KUKSA Authorization Compatibility 0.11](kuksa-authorization-compatibility.md) | `KAC` | D3 design-reviewed 2026-08-28; complete D4-027.1 through D4-027.8 helper contract plus exact current-demo filesystem, SELinux and PKCS#11 boundary accepted; implementation open |
