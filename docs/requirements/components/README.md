...
| 2 | [`CR-FACTORY`](../component-decomposition-and-interface-register.md#cr-factory) | [Factory Substrate 0.4](factory-substrate.md) | `FACTORY` | D3 design-reviewed 2026-08-28; separately packaged `CMP-KAC` factory seam accepted; implementation and qualification open |
| 2 | [`CR-KAC`](../component-decomposition-and-interface-register.md#cr-kac) | [Current-Release KUKSA Authorization Compatibility 0.8](kuksa-authorization-compatibility.md) | `KAC` | D3 design-reviewed 2026-08-28; complete D4-027.1 through D4-027.8 helper contract accepted; implementation open |
| 2 | [`CR-VDP`](../component-decomposition-and-interface-register.md#cr-vdp) | [Vehicle Data Platform 0.8](vehicle-data-platform.md) | `VDP` | D3 design-reviewed 2026-08-28; Service authorization removed and trusted OEM Provider integration accepted; implementation and qualification open |
...
| 4 | [`CR-BHS`](../component-decomposition-and-interface-register.md#cr-bhs) | [Brake Health Service 0.7](brake-health-service.md) | `BHS` | D4-016.1/.2 accepted; exact .3/.4/.5 and D4-017 review candidates prepared |
| 4 | [`CR-BRAKE-CLOUD`](../component-decomposition-and-interface-register.md#cr-brake-cloud) | [Brake Health Cloud Product 0.4](brake-health-cloud.md) | `BRAKE-CLOUD` | D3 design-reviewed; D4-017 and D4-020 review candidates prepared |
