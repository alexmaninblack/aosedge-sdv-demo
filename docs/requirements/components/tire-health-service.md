...
| <a id="ut-tire-007"></a>`UT-TIRE-007` | `REQ-TIRE-008` | Only the accepted typed target succeeds; malformed/arbitrary/motion requests fail; ordinary restart preserves epoch/sequence, explicit replacement rotates once and starts at `1`, R0 destroys state and late old-epoch evidence cannot mutate current |
