...
export interface CloudComponent { reported_component_id: string | null; type: string | null; installed_component: { version: string | null } | null; pending_component: { version: string | null } | null; pending_component_status: string | null; pending_component_error?: string | null; runtimeState: string }
