...
export interface CloudInventory { unitId: string; systemUid: string; readCompletedAt: string; components: CloudSection<CloudComponent[]>; services: CloudSection<CloudService[]>; nodes: CloudSection<{ node_id: string | null; status: string | null; num_cpus: number | null; max_dmips: number | null; total_ram: number | null }[]>; layers: CloudSection<unknown[]>; assignedSubjects: CloudSection<unknown[]> }
