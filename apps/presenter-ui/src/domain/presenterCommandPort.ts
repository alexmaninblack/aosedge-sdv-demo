export type DemoAction = "prepare-demo" | "create" | "start-vms" | "stop-vms" | "provision" | "start-simulation" | "stop-simulation" | "connect-test" | "reset"
...
export interface DemoJob { id: string; action: DemoAction; version?: string; profile?: string; state: string; startedAt: string; finishedAt?: string; reason?: string;
