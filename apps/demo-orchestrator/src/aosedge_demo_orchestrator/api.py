...
def execute_operation(
    ...
    if domain == "component" and action.startswith(("cm-compare-", "core-permissions-")):
        raise ValueError("CM comparison is an explicitly authorized CLI-only engineering experiment")
